...
- report_generated_at_utc: `2026-03-11T07:27:48Z`
...
## 快速摘要（非預測，僅狀態）
- state: **NEAR_UPPER_BAND**; bb_z=1.4226; pos=0.8557 (raw=0.8557); bw_geo=41.33%; bw_std=34.25%
- dist_to_lower=26.13%; dist_to_upper=4.41%; above_upper=0.00%; below_lower=0.00%; DQ=PRICE_SERIES_BREAK_DETECTED, FWD_MDD_CLEAN_APPLIED, RAW_OUTLIER_EXCLUDED_BY_CLEAN; FWD_OUTLIER=20D
...
- trend_filter(MA200,slope20D,thr=0.50%): price_vs_ma=34.71%; slope=6.42% => **TREND_UP**
- vol_filter(RV20,ATR14): rv_ann=38.9%; atr=2.0931 (2.68%)
- regime(relative_pctl): **RISK_OFF_OR_DEFENSIVE**; allowed=false; rv20_pctl=96.68
- margin(5D,thr=100.00億): TOTAL -217.90 億 => **DELEVERAGING**; TWSE -161.10 / TPEX -56.80; margin_date=2026-03-10, price_last_date=2026-03-11 (MISALIGNED); data_date=2026-03-10
- chip_overlay(T86+TWT72U,5D): total3_5D=-961,996,196; foreign=-623,741,111; trust=15,820,000; dealer=-354,075,085; borrow_shares=243,676,000 (Δ1D=1,760,000); borrow_mv(億)=183.2 (Δ1D=5.2); asof=20260310; price_last_date=2026-03-11 (ALIGNED)
...
|---|---:|---:|
| 10D_p10_uncond | -4.80% | 74.45 |
| 10D_p05_uncond | -6.30% | 73.27 |
...
| bb_lower | 57.7684 |
| bb_z | 1.4226 |
| pos_in_band (clipped) | 0.8557 |
| pos_in_band_raw (unclipped) | 0.8557 |
| dist_to_lower | 26.13% |
| dist_to_upper | 4.41% |
| above_upper_pct | 0.00% |
| below_lower_pct | 0.00% |
| band_width_geo_pct (upper/lower-1) | 41.33% |
| band_width_std_pct ((upper-lower)/ma) | 34.25% |
...
|---|---:|
| trend_ma_days | 200 |
| trend_ma_last | 58.0500 |
| trend_slope_days | 20 |
| trend_slope_pct | 6.42% |
| price_vs_trend_ma_pct | 34.71% |
| trend_state | TREND_UP |
...
- overlay_generated_at_utc: `2026-03-11T07:27:48.412Z`
- stock_no: `0050`
...
- overlay_generated_at_utc: `2026-03-10T23:07:05Z`
- data_date: `2026-03-10`
- params: window_n=5, threshold_yi=100.00
- date_alignment: margin_latest_date=`2026-03-10` vs price_last_date=`2026-03-11` => **MISALIGNED**
