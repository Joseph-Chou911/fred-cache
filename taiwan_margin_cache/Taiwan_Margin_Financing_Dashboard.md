...
- Check-6 roll25 UsedDate 與 TWSE 最新日期一致（confirm-only）：⚠️（NOTE）（roll25 stale (UsedDateStatus=DATA_NOT_UPDATED) | UsedDate(2026-03-02) vs TWSE(2026-03-03)）
- Check-7 roll25 Lookback window（info）：⚠️（NOTE）（skipped: roll25 stale (DATA_NOT_UPDATED)）
- Check-10 maint latest vs history[0] date（info）：⚠️（NOTE）（latest.data_date(NA) != hist[0].data_date(2026-03-02)）
...
_generated_at_utc: 2026-03-03T15:13:04Z_
