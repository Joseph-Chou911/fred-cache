...
- as_of_ts (TPE): `2026-03-11T00:30:47.201420+08:00`
- run_ts_utc: `2026-03-10T16:30:47.201404Z`
- bottom_state (Global): **PANIC_BUT_SYSTEMIC**  (streak=7)
- market_cache_as_of_ts: `2026-03-10T03:14:01Z`
- market_cache_generated_at_utc: `2026-03-10T03:14:01Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `32`
- history_pre_items: `32`; history_post_items: `33`; pre_unique_days: `32`; post_unique_days: `33`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260310T163047Z.json`; bytes=`29868`; keep_n=`30`; prune_deleted=`1`
...
- VIX panic gap: `-5.5000`
- SP500 ret1% gap: `2.3304`
- HYG veto gap(z): `0.5143`
- OFR veto gap(z): `-0.6653`

## Context (Non-trigger) - Global
- SP500.p252: `70.23809523809523`; equity_extreme(p252>=95): `0`

## TW Local Gate (roll25 + margin)
- tw_state: **NONE**  (streak=33)
- UsedDate: `2026-03-09`; run_day_tag: `WEEKDAY`; used_date_status: `DATA_NOT_UPDATED`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3682.4` 億
- margin_chg(TWSE latest): `-37.2` 億
- margin_flow_audit: signal=`NONE`; sum_last5=`-161.1`; pos_days_last5=`2`
