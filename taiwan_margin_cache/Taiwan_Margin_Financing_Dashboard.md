...
- Check-6 roll25 UsedDate 與 TWSE 最新日期一致（confirm-only）：⚠️（NOTE）（roll25 stale (UsedDateStatus=DATA_NOT_UPDATED) | UsedDate(2026-02-26) == TWSE(2026-02-26)）
...
_generated_at_utc: 2026-02-27T15:07:15Z_
