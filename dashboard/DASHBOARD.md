...
- SCRIPT_FINGERPRINT: `render_dashboard_py_signals_v8@7867eb7`
- RULESET_ID: `signals_v8`
- RUN_TS_UTC: `2026-03-02T15:29:57.591192+00:00`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ALERT | JUMP_ZD,JUMP_P,JUMP_RET | NA | HIGH | DIR_UNCERTAIN_ABS | ALERT | SAME | 11 | 12 | OFR_FSI | OK | 8.51 | 2026-02-25 | -2.601 | -0.510445 | 35 | 8.333333 | -0.870551 | -1.192663 | -38.333333 | -10.964164 | abs(ZΔ60)>=0.75;abs(PΔ60)>=15;abs(ret1%1d)>=2 | https://www.financialresearch.gov/financial-stress-index/data/fsi.csv | 2026-03-02T06:59:39Z |
| ALERT | EXTREME_Z,JUMP_ZD | NA | LOW | DIR_UNCERTAIN_ABS | ALERT | SAME | 3 | 4 | HYG_IEF_RATIO | OK | 8.51 | 2026-02-27 | 0.823758 | -2.799425 | 1.666667 | 6.349206 | -1.468247 | -0.750161 | 0 | -0.558151 | abs(Z60)>=2;abs(Z60)>=2.5;abs(ZΔ60)>=0.75 | DERIVED | 2026-03-02T06:59:39Z |
| WATCH | JUMP_RET | NA | HIGH | DIR_UNCERTAIN_ABS | WATCH | SAME | 12 | 13 | VIX | OK | 8.51 | 2026-02-27 | 19.86 | 1.379544 | 86.666667 | 73.015873 | 0.168007 | 0.537564 | 8.333333 | 6.602254 | abs(ret1%1d)>=2 | https://cdn.cboe.com/api/global/us_indices/daily_prices/VIX_History.csv | 2026-03-02T06:59:39Z |
| WATCH | JUMP_P | NA | HIGH | DIR_UNCERTAIN_ABS | WATCH | SAME | 9 | 10 | SP500 | OK | 8.51 | 2026-02-27 | 6878.88 | -0.230106 | 40 | 84.920635 | 1.02806 | -0.541274 | -15 | -0.433936 | abs(PΔ60)>=15 | https://stooq.com/q/d/l/?s=^spx&i=d | 2026-03-02T06:59:39Z |
