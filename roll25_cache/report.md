...
## 1) Summary
- generated_at_utc: `2026-02-20T19:01:42Z`
- generated_at_local: `2026-02-21T03:01:42.283828+08:00`
- report_date_local: `2026-02-21`
- timezone: `Asia/Taipei`
- as_of_data_date: `2026-02-11` (latest available)
- data_age_days: `10` (warn_if > 2)
- ⚠️ staleness_warning: as_of_data_date is 10 days behind report_date_local (可能跨週末/長假；請避免當作「今日盤後」解讀)
- RunDayTag: `WEEKEND`
- summary: 今日為週末；UsedDate=2026-02-11：Mode=FULL；freshness_ok=False
...
freshness_ok=False | freshness_age_days=10
dedupe_ok=True
