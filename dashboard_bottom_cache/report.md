...
- as_of_ts (TPE): `2026-02-28T23:40:26.856407+08:00`
- run_ts_utc: `2026-02-28T15:40:26.856395Z`
- bottom_state (Global): **NONE**  (streak=3)
- market_cache_as_of_ts: `2026-02-28T02:59:48Z`
- market_cache_generated_at_utc: `2026-02-28T02:59:48Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `23`
- history_pre_items: `23`; history_post_items: `24`; pre_unique_days: `23`; post_unique_days: `24`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260228T154026Z.json`; bytes=`21432`; keep_n=`30`; prune_deleted=`1`
