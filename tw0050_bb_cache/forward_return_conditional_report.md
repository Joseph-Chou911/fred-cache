...
- input_generated_at_utc: `2026-02-23T07:42:30Z`
...
- stats_generated_at_utc: `2026-02-23T07:37:50Z`
...
| --- | --- | --- | --- | --- | --- |
| 1238 | 2014-01-02 | 2013-12-31 | 37.412407 | 9.329200 | 0.249361122650 |

## Current
- asof_date: `2026-02-23`
- current_bb_z: `1.994536`
...
| --- | --- | --- | --- | --- | --- | --- |
| <=-2 | 205 | -17.53% | 2020-03-09 | 18.100201 | 2020-03-23 | 14.927131 |
| (-2,-1.5] | 205 | -20.00% | 2025-03-24 | 44.736397 | 2025-04-09 | 35.789116 |
| (-1.5,1.5) | 2641 | -24.00% | 2020-03-05 | 19.017332 | 2020-03-19 | 14.452750 |
| [1.5,2) | 656 | -10.09% | 2009-06-03 | 29.758423 | 2009-06-17 | 26.757051 |
...
| <=-2 | 205 | -17.53% | 2020-03-09 | 18.100201 | 2020-03-23 | 14.927131 |
| (-2,-1.5] | 205 | -20.00% | 2025-03-24 | 44.736397 | 2025-04-09 | 35.789116 |
| (-1.5,1.5) | 2648 | -75.13% | 2013-12-25 | 36.870659 | 2014-01-09 | 9.169867 |
| [1.5,2) | 657 | -75.17% | 2013-12-27 | 37.157475 | 2014-01-13 | 9.225633 |
| >=2 | 409 | -75.43% | 2013-12-30 | 37.476147 | 2014-01-14 | 9.209700 |

### excluded_entries_sample (first up to 5)

| entry_idx | entry_date | entry_price | first_break_idx | first_break_date | break_ratio |
| --- | --- | --- | --- | --- | --- |
| 1228 | 2013-12-18 | 36.328918 | 1238 | 2014-01-02 | 0.249361122650 |
| 1229 | 2013-12-19 | 36.551987 | 1238 | 2014-01-02 | 0.249361122650 |
| 1230 | 2013-12-20 | 36.615730 | 1238 | 2014-01-02 | 0.249361122650 |
| 1231 | 2013-12-23 | 36.870659 | 1238 | 2014-01-02 | 0.249361122650 |
| 1232 | 2013-12-24 | 36.838799 | 1238 | 2014-01-02 | 0.249361122650 |
...
| >=2 | 397 | 69.77% | 9.27% | 1.85% | -0.49% | -3.79% | -5.15% | -17.11% |
...
| (-1.5,1.5) | 2632 | -25.57% | 2020-02-19 | 19.417915 | 2020-03-19 | 14.452750 |
| [1.5,2) | 655 | -12.22% | 2024-07-05 | 46.076263 | 2024-08-06 | 40.444271 |
| >=2 | 397 | -17.11% | 2024-07-04 | 46.244427 | 2024-08-05 | 38.331512 |
...
| >=2 | 399 | 69.42% | 9.27% | 1.83% | -0.64% | -3.86% | -5.62% | -76.28% |
...
| [1.5,2) | 657 | -75.30% | 2013-12-27 | 37.157475 | 2014-01-27 | 9.177831 |
| >=2 | 399 | -76.28% | 2013-12-30 | 37.476147 | 2014-02-05 | 8.891026 |

### excluded_entries_sample (first up to 5)

| entry_idx | entry_date | entry_price | first_break_idx | first_break_date | break_ratio |
| --- | --- | --- | --- | --- | --- |
| 1218 | 2013-12-04 | 36.615730 | 1238 | 2014-01-02 | 0.249361122650 |
| 1219 | 2013-12-05 | 36.392647 | 1238 | 2014-01-02 | 0.249361122650 |
| 1220 | 2013-12-06 | 36.424519 | 1238 | 2014-01-02 | 0.249361122650 |
| 1221 | 2013-12-09 | 36.743187 | 1238 | 2014-01-02 | 0.249361122650 |
| 1222 | 2013-12-10 | 36.838799 | 1238 | 2014-01-02 | 0.249361122650 |
...
```json
{
  "metrics": {
    ...
    "clean_n_total": 4094,
    "excluded_by_break_mask": 20,
    "clean_bucket_n_sum": 4094,
    "raw_bucket_n_sum": 4114
  },
  "eps": 1e-12
}
```
...
- stats_last_date (from stats_json): `2026-02-23`
- stats_last_date (recorded in forward_return_conditional.json): `2026-02-23`
- price_last_date (from forward_return_conditional.json): `2026-02-23`
- current.asof_date (from forward_return_conditional.json): `2026-02-23`
