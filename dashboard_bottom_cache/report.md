...
- as_of_ts (TPE): `2026-03-02T23:58:33.203588+08:00`
- run_ts_utc: `2026-03-02T15:58:33.203567Z`
- bottom_state (Global): **NONE**  (streak=5)
- market_cache_as_of_ts: `2026-03-02T06:59:39Z`
- market_cache_generated_at_utc: `2026-03-02T06:59:39Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `25`
- history_pre_items: `25`; history_post_items: `26`; pre_unique_days: `25`; post_unique_days: `26`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260302T155833Z.json`; bytes=`23294`; keep_n=`30`; prune_deleted=`1`
...
- tw_state: **NONE**  (streak=26)
- UsedDate: `2026-02-26`; run_day_tag: `WEEKDAY`; used_date_status: `DATA_NOT_UPDATED`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3916.2` 億
- margin_chg(TWSE latest): `17.6` 億
- margin_flow_audit: signal=`ALERT`; sum_last5=`241.2`; pos_days_last5=`5`
