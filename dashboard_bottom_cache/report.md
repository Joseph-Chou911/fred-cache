...
- as_of_ts (TPE): `2026-03-15T23:48:20.639713+08:00`
- run_ts_utc: `2026-03-15T15:48:20.639699Z`
- bottom_state (Global): **PANIC_BUT_SYSTEMIC**  (streak=1)
- market_cache_as_of_ts: `2026-03-15T03:42:20Z`
- market_cache_generated_at_utc: `2026-03-15T03:42:20Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `35`
- history_pre_items: `35`; history_post_items: `36`; pre_unique_days: `35`; post_unique_days: `36`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260315T154820Z.json`; bytes=`32666`; keep_n=`30`; prune_deleted=`1`
...
- VIX panic gap: `-7.1900`
- SP500 ret1% gap: `0.8941`
- HYG veto gap(z): `0.6508`
- OFR veto gap(z): `-0.7215`

## Context (Non-trigger) - Global
- SP500.p252: `54.761904761904766`; equity_extreme(p252>=95): `0`

## TW Local Gate (roll25 + margin)
- tw_state: **NONE**  (streak=36)
- UsedDate: `2026-03-13`; run_day_tag: `WEEKEND`; used_date_status: `OK_LATEST`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3854.5` 億
- margin_chg(TWSE latest): `60.8` 億
- margin_flow_audit: signal=`NONE`; sum_last5=`27.7`; pos_days_last5=`3`
...
| 2026-03-13 | 2026-03-13T23:59:49.177133+08:00 | BOTTOM_WATCH | 1 | 0 | 0 | NONE | 0 | 0 | 0 | NONE | DOWNGRADED |
| 2026-03-15 | 2026-03-15T23:48:20.639713+08:00 | PANIC_BUT_SYSTEMIC | 1 | 1 | 0 | NONE | 0 | 0 | 0 | NONE | DOWNGRADED |
