...
- Slice A（pos≥0.80）：p50=-1.515%、p10=-5.415%、p5=-6.982%、min=-31.285% (n=1717, conf=HIGH, conf_decision=OK, min_n_required=200)
- Slice B（dist_to_upper≤2.0%）：p50=-1.448%、p10=-5.467%、p5=-6.982%、min=-31.285% (n=1757, conf=HIGH, conf_decision=OK, min_n_required=200)
