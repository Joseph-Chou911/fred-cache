...
- as_of_ts (TPE): `2026-02-17T00:00:15.943555+08:00`
- run_ts_utc: `2026-02-16T16:00:15.943536Z`
- bottom_state (Global): **BOTTOM_CANDIDATE**  (streak=3)
- market_cache_as_of_ts: `2026-02-16T03:31:51Z`
- market_cache_generated_at_utc: `2026-02-16T03:31:51Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `13`
- history_pre_items: `13`; history_post_items: `14`; pre_unique_days: `13`; post_unique_days: `14`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260216T160015Z.json`; bytes=`12099`; keep_n=`30`; prune_deleted=`0`
