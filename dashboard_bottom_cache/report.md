...
- as_of_ts (TPE): `2026-02-02T23:55:16.505649+08:00`
- run_ts_utc: `2026-02-02T15:55:16.505634Z`
- bottom_state (Global): **NONE**  (streak=2)
- market_cache_as_of_ts: `2026-02-02T15:12:17Z`
- market_cache_generated_at_utc: `2026-02-02T15:12:17Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `1`
- history_pre_items: `1`; history_post_items: `2`; pre_unique_days: `1`; post_unique_days: `2`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260202T155516Z.json`; bytes=`987`; keep_n=`30`; prune_deleted=`0`
...
- SP500 ret1% gap: `1.9403`
- HYG veto gap(z): `3.3190`
...
- UsedDate: `2026-01-30`; run_day_tag: `WEEKDAY`; used_date_status: `DATA_NOT_UPDATED`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3788.5` 億
- margin_chg(TWSE latest): `-50.4` 億
- margin_flow_audit: signal=`NONE`; sum_last5=`-27.2`; pos_days_last5=`3`
