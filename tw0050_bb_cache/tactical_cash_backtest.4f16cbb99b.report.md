...
- generated_at_utc: `2026-03-13T07:53:45Z`
...
## Snapshot (audit)
- rows: `2967`
- date_range: `2014-01-03` ~ `2026-03-13`
- time_in_market_pct (tactical leg): `0.6977`

## Performance (overlay vs base-only)

| metric | overlay | base_only | delta_vs_base |
|---|---:|---:|---:|
| CAGR | 19.00% | 18.69% | 0.30% |
| MDD | -32.73% | -32.81% | 0.08% |
| Sharpe0 | 1.058 | 1.057 | 0.001 |

## Trade KPIs (tactical leg)
- n_trades: `77`
- win_rate: `0.3506`
- avg_net_pnl (per trade, equity units): `0.002987`
- profit_factor: `2.8846`
- avg_hold_days: `26.90`
