...
- as_of_ts (TPE): `2026-02-18T00:12:59.926117+08:00`
- run_ts_utc: `2026-02-17T16:12:59.926106Z`
- bottom_state (Global): **BOTTOM_CANDIDATE**  (streak=4)
- market_cache_as_of_ts: `2026-02-17T08:06:20Z`
- market_cache_generated_at_utc: `2026-02-17T08:06:20Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `14`
- history_pre_items: `14`; history_post_items: `15`; pre_unique_days: `14`; post_unique_days: `15`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260217T161259Z.json`; bytes=`13039`; keep_n=`30`; prune_deleted=`0`
