...
- report_generated_at_utc: `2026-03-13T15:51:39Z`
...
- margin(5D,thr=100.00億): TOTAL -10.20 億 => **NEUTRAL**; TWSE 27.70 / TPEX -37.90; margin_date=2026-03-13, price_last_date=2026-03-13 (ALIGNED); data_date=2026-03-13
- chip_overlay(T86+TWT72U,5D): total3_5D=-554,794,906; foreign=-390,551,359; trust=13,180,000; dealer=-177,423,547; borrow_shares=246,976,000 (Δ1D=3,300,000); borrow_mv(億)=187.6 (Δ1D=0.9); asof=20260313; price_last_date=2026-03-13 (ALIGNED)
...
| [1.5,2) | 1.5_to_2.0 | 657 | -0.0167 | -0.0358 | -0.0600 | -0.0734 | -0.1935 |
...
| >=2 | z_ge_2.0 | 411 | -0.0084 | -0.0187 | -0.0327 | -0.0522 | -0.1126 |
...
| rv20_percentile | 96.54 |
| rv_pctl_max | 60.00 |
| dq_core | PRICE_SERIES_BREAK_DETECTED, FWD_MDD_CLEAN_APPLIED, RAW_OUTLIER_EXCLUDED_BY_CLEAN |
| margin_note | margin(aligned): total_state=NEUTRAL, total_sum=-10.200000000000031 |
| pledge_block_in_stats | true |
| pledge_version | pledge_guidance_v1 |
| pledge_scope | compute_only_no_margin_no_chip |
| pledge_source | stats |
...
|---|---:|---:|
| 10D_p10_uncond | -4.81% | 72.29 |
| 10D_p05_uncond | -6.36% | 71.12 |
| 20D_p10_uncond | -6.86% | 70.74 |
| 20D_p05_uncond | -9.26% | 68.91 |

- source: stats (price_anchor=75.95)
...
| bb_lower | 58.8101 |
| bb_z | 0.9511 |
| pos_in_band (clipped) | 0.7378 |
| pos_in_band_raw (unclipped) | 0.7378 |
| dist_to_lower | 22.57% |
| dist_to_upper | 8.02% |
| above_upper_pct | 0.00% |
| below_lower_pct | 0.00% |
| band_width_geo_pct (upper/lower-1) | 39.50% |
| band_width_std_pct ((upper-lower)/ma) | 32.99% |
...
|---|---:|
| trend_ma_days | 200 |
| trend_ma_last | 58.5175 |
| trend_slope_days | 20 |
| trend_slope_pct | 6.33% |
| price_vs_trend_ma_pct | 29.79% |
| trend_state | TREND_UP |
...
- overlay_generated_at_utc: `2026-03-13T15:51:39.148Z`
- stock_no: `0050`
...
|---|---:|
| asof_date | 20260313 |
| borrow_shares | 246,976,000 |
| borrow_shares_chg_1d | 3,300,000 |
| borrow_mv_ntd(億) | 187.6 |
| borrow_mv_ntd_chg_1d(億) | 0.9 |

### T86 Aggregate（法人：5D sum）

| item | value |
|---|---:|
| days_used | 20260309, 20260310, 20260311, 20260312, 20260313 |
| foreign_net_shares_sum | -390,551,359 |
| trust_net_shares_sum | 13,180,000 |
| dealer_net_shares_sum | -177,423,547 |
| total3_net_shares_sum | -554,794,906 |

### ETF Units（受益權單位）

| item | value |
|---|---:|
| units_outstanding | 17,790,000,000 |
| units_chg_1d | 36,500,000 |
| dq | (none) |
...
- overlay_generated_at_utc: `2026-03-13T15:09:41Z`
- data_date: `2026-03-13`
- params: window_n=5, threshold_yi=100.00
- date_alignment: margin_latest_date=`2026-03-13` vs price_last_date=`2026-03-13` => **ALIGNED**

| scope | latest_date | balance(億) | chg_today(億) | chg_ND_sum(億) | state_ND | rows_used |
|---|---:|---:|---:|---:|---:|---:|
| TWSE | 2026-03-13 | 3,854.5 | 60.8 | 27.7 | NEUTRAL | 5 |
| TPEX | 2026-03-13 | 1,355.3 | 2.5 | -37.9 | NEUTRAL | 5 |
| TOTAL | 2026-03-13 | 5,209.8 | N/A | -10.2 | NEUTRAL | N/A |
...
| 2026-03-12 | 76.6000 | 76.6000 | 120680192 |
| 2026-03-13 | 75.9500 | 75.9500 | 114910344 |
