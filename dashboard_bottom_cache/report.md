...
- as_of_ts (TPE): `2026-03-12T00:07:22.009328+08:00`
- run_ts_utc: `2026-03-11T16:07:22.009311Z`
- bottom_state (Global): **PANIC_BUT_SYSTEMIC**  (streak=8)
- market_cache_as_of_ts: `2026-03-11T03:13:04Z`
- market_cache_generated_at_utc: `2026-03-11T03:13:04Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `33`
- history_pre_items: `33`; history_post_items: `34`; pre_unique_days: `33`; post_unique_days: `34`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260311T160722Z.json`; bytes=`30796`; keep_n=`30`; prune_deleted=`1`
...
- VIX panic gap: `-4.9300`
- SP500 ret1% gap: `1.2865`
- HYG veto gap(z): `0.7714`
- OFR veto gap(z): `-2.1822`

## Context (Non-trigger) - Global
- SP500.p252: `69.44444444444444`; equity_extreme(p252>=95): `0`

## TW Local Gate (roll25 + margin)
- tw_state: **NONE**  (streak=34)
- UsedDate: `2026-03-10`; run_day_tag: `WEEKDAY`; used_date_status: `DATA_NOT_UPDATED`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3761.5` 億
- margin_chg(TWSE latest): `79.1` 億
- margin_flow_audit: signal=`NONE`; sum_last5=`-4.6`; pos_days_last5=`3`
