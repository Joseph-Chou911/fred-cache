...
- as_of_ts (TPE): `2026-02-07T00:00:20.833714+08:00`
- run_ts_utc: `2026-02-06T16:00:20.833701Z`
- bottom_state (Global): **BOTTOM_WATCH**  (streak=1)
- market_cache_as_of_ts: `2026-02-06T03:18:01Z`
- market_cache_generated_at_utc: `2026-02-06T03:18:01Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `5`
- history_pre_items: `5`; history_post_items: `6`; pre_unique_days: `5`; post_unique_days: `6`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260206T160020Z.json`; bytes=`4657`; keep_n=`30`; prune_deleted=`0`
...
- VIX panic gap: `-1.7700`
- SP500 ret1% gap: `0.2749`
- HYG veto gap(z): `2.1500`
- OFR veto gap(z): `1.7624`

## Context (Non-trigger) - Global
- SP500.p252: `78.96825396825396`; equity_extreme(p252>=95): `0`

## TW Local Gate (roll25 + margin)
- tw_state: **NONE**  (streak=6)
- UsedDate: `2026-02-05`; run_day_tag: `WEEKDAY`; used_date_status: `DATA_NOT_UPDATED`
- Lookback: `20/20`
...
| 2026-02-07 | 2026-02-07T00:00:20.833714+08:00 | BOTTOM_WATCH | 1 | 0 | 0 | NONE | 0 | 0 | 0 | NONE | DOWNGRADED |
