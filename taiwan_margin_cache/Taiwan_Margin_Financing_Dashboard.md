...
- Check-6 roll25 UsedDate 與 TWSE 最新日期一致（confirm-only）：⚠️（NOTE）（roll25 stale (UsedDateStatus=DATA_NOT_UPDATED) | UsedDate(2026-02-10) vs TWSE(2026-02-11)）
...
_generated_at_utc: 2026-02-11T15:34:36Z_
