...
- input_generated_at_utc: `2026-03-06T07:28:00Z`
...
- stats_generated_at_utc: `2026-03-06T07:13:13Z`
...
| [1.5,2) | 660 | 56.67% | 4.62% | 0.63% | -1.23% | -3.30% | -4.76% | -10.09% |
...
| [1.5,2) | 660 | -10.09% | 2009-06-03 | 29.758427 | 2009-06-17 | 26.757051 |
| >=2 | 407 | -10.47% | 2024-07-11 | 48.706791 | 2024-07-29 | 43.607376 |
...
| [1.5,2) | 661 | 56.58% | 4.61% | 0.62% | -1.24% | -3.31% | -4.77% | -75.17% |
...
| [1.5,2) | 661 | -75.17% | 2013-12-27 | 37.157475 | 2014-01-13 | 9.225636 |
...
| --- | --- | --- | --- | --- | --- |
| 1228 | 2013-12-18 | 36.328915 | 1238 | 2014-01-02 | 0.249361148141 |
| 1229 | 2013-12-19 | 36.551987 | 1238 | 2014-01-02 | 0.249361148141 |
| 1230 | 2013-12-20 | 36.615723 | 1238 | 2014-01-02 | 0.249361148141 |
| 1231 | 2013-12-23 | 36.870663 | 1238 | 2014-01-02 | 0.249361148141 |
| 1232 | 2013-12-24 | 36.838799 | 1238 | 2014-01-02 | 0.249361148141 |
...
| >=2 | 404 | 70.30% | 9.49% | 1.91% | -0.44% | -3.75% | -5.08% | -17.11% |
...
| >=2 | 404 | -17.11% | 2024-07-04 | 46.244427 | 2024-08-05 | 38.331509 |
...
| >=2 | 406 | 69.95% | 9.49% | 1.88% | -0.49% | -3.83% | -5.52% | -76.28% |
...
| >=2 | 406 | -76.28% | 2013-12-30 | 37.476143 | 2014-02-05 | 8.891024 |

### excluded_entries_sample (first up to 5)

| entry_idx | entry_date | entry_price | first_break_idx | first_break_date | break_ratio |
| --- | --- | --- | --- | --- | --- |
| 1218 | 2013-12-04 | 36.615723 | 1238 | 2014-01-02 | 0.249361148141 |
| 1219 | 2013-12-05 | 36.392654 | 1238 | 2014-01-02 | 0.249361148141 |
| 1220 | 2013-12-06 | 36.424522 | 1238 | 2014-01-02 | 0.249361148141 |
| 1221 | 2013-12-09 | 36.743195 | 1238 | 2014-01-02 | 0.249361148141 |
| 1222 | 2013-12-10 | 36.838799 | 1238 | 2014-01-02 | 0.249361148141 |
...
```json
{
  "metrics": {
    ...
    "clean_n_total": 4121,
    "excluded_by_break_mask": 10,
    "clean_bucket_n_sum": 4121,
    "raw_bucket_n_sum": 4131
  },
  "eps": 1e-12
}
```
...
```json
{
  "metrics": {
    ...
    "clean_n_total": 4101,
    "excluded_by_break_mask": 20,
    "clean_bucket_n_sum": 4101,
    "raw_bucket_n_sum": 4121
  },
  "eps": 1e-12
}
```
...
- stats_last_date (from stats_json): `2026-03-06`
- stats_last_date (recorded in forward_return_conditional.json): `2026-03-06`
- price_last_date (from forward_return_conditional.json): `2026-03-06`
- current.asof_date (from forward_return_conditional.json): `2026-03-06`
