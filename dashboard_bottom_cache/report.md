...
- as_of_ts (TPE): `2026-02-25T00:32:15.907695+08:00`
- run_ts_utc: `2026-02-24T16:32:15.907679Z`
- bottom_state (Global): **BOTTOM_WATCH**  (streak=1)
- market_cache_as_of_ts: `2026-02-24T03:22:23Z`
- market_cache_generated_at_utc: `2026-02-24T03:22:23Z`
- history_load_status: `OK`; reason: `dict.items`; loaded_items: `20`
- history_pre_items: `20`; history_post_items: `21`; pre_unique_days: `20`; post_unique_days: `21`
- history_write: status=`OK`; reason=`ok`; allow_reset=`False`; allow_shrink=`False`
- history_backup: status=`OK`; reason=`copied_pre_write`; file=`dashboard_bottom_cache/history.json.bak.20260224T163215Z.json`; bytes=`18637`; keep_n=`30`; prune_deleted=`0`
...
- VIX panic gap: `-1.0100`
- SP500 ret1% gap: `0.4614`
- HYG veto gap(z): `0.3233`
- OFR veto gap(z): `1.4006`

## Context (Non-trigger) - Global
- SP500.p252: `79.36507936507937`; equity_extreme(p252>=95): `0`

## TW Local Gate (roll25 + margin)
- tw_state: **NONE**  (streak=21)
- UsedDate: `2026-02-24`; run_day_tag: `WEEKDAY`; used_date_status: `OK_TODAY`
- Lookback: `20/20`
...
- margin_balance(TWSE latest): `3775.0` 億
- margin_chg(TWSE latest): `53.4` 億
- margin_flow_audit: signal=`NONE`; sum_last5=`40.6`; pos_days_last5=`3`
